### Решение задач по С++ (кол -во: 42шт )
...
3. Folder Task-solution_3 (Задачи по логическим операторам и операторам ветвлений и задачи по циклам);
4. Folder Task-solution_5 (Задачи с многомерными массивами и задачи по функциям);
